  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore my portfolio showcasing my skills, projects, experience, and education" />
      </Head>
      <TransitionEffect />
      <main className='flex items-center text-dark w-full min-h-screen dark:text-light'>
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div classname="w-1/2 md:w-full">
              <Image src={profilePic} alt="DT" className="w-full h-auto lg:hidden md:inline-block md:w-full" 
              priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                ...
                <Link href="mailto:dbt2700@gmail.com" target={"_blank"}
        ...
        <div className='absolute right-8 bottom-5 inline-block w-24 md:hidden'>
          <Image src={lightBulb} alt="DT" className='w-full h-auto' />
        </div>
      </main>
    </>
  )
